        ...
        <div className="max-w-2xl mx-auto px-6 sm:px-16">
          ...
          {[
            ...
            },
            {
              ...
              a: "Recommendations are generated by Claude, an AI from Anthropic, using your literary fingerprint. Your fingerprint is matched against a wide range of books to find titles that fit the specific combination of traits that define how you read. The goal is to surface books you haven't heard of but would have loved, not just more of what you've already finished.",
            },
            {
            ...
            },
            {
              ...
              a: "Yes. The Free tier includes your full literary fingerprint, trait breakdown, character archetype, and 3 recommendations. No subscription required to use the core experience.",
            },
          ].map(({ q, a }) => (
            <details key={q} className="group border-b border-[#E8E4DC] py-5 first:border-t">
              ...
              <p className="mt-4 text-[#6B6B6B] leading-relaxed text-[15px]">{a}</p>
            </details>
          ))}
        </div>
      </section>
