  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] font-[family-name:var(--font-jakarta)] overflow-x-hidden">
      ...
      <section id="faq" className="bg-[#FAFAF8] py-24">
        <div className="max-w-2xl mx-auto px-6 sm:px-16">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#1A1A1A] mb-12">Common questions.</h2>

          {[
            {
              q: "What is a literary fingerprint?",
              a: "Your literary fingerprint is a detailed profile of how you read, not just what you've read. Ethos analyzes your reading history to identify patterns in the prose styles you gravitate toward, the pacing you prefer, the themes that recur, and the emotional register you seek. The result captures your reading identity at a level that 'you liked this author' doesn't come close to.",
            },
            {
              q: "How does Ethos choose my recommendations?",
              a: "Your literary fingerprint is the engine. Ethos matches it against a wide range of books to find titles that fit the specific combination of traits that define how you read, using AI to do the matching. The goal is to surface books you haven't heard of but would have loved, not just more of what you've already finished.",
            },
            {
              q: "What is a character archetype?",
              a: "Your character archetype is a classic literary character whose way of engaging with the world mirrors yours as a reader. It's not based on your personality or what you look like — it's derived from the reading patterns in your fingerprint. If you gravitate toward moral complexity and wit, you might be Elizabeth Bennet. If you prefer analytical rigor and novelty, you might be Sherlock Holmes.",
            },
            {
              q: "When do my recommendations refresh?",
              a: "On Premium, your recommendations refresh weekly and also update automatically when you add 5 or more books to your library. On Free, your 3 starter recommendations don't change until you upgrade.",
            },
            {
              q: "Can I rebuild my fingerprint?",
              a: "Yes. Premium members can rebuild their fingerprint at any time after adding 5 or more new books. Your taste changes over time, and rebuilding ensures your recommendations stay current.",
            },
            {
              q: "Is my reading data private?",
              a: "Your reading data is sent to Anthropic's Claude to generate your fingerprint and recommendations, and is never used to train AI models. We don't sell your data, share it with advertisers, or use it for anything other than making Ethos work. You can delete your account and all associated data at any time from Settings.",
            },
            {
              q: "Will Ethos work without a subscription?",
              a: "Yes. The Free tier includes your full literary fingerprint, trait breakdown, character archetype, and 3 recommendations. Ethos is also a full reading tracker: build your library, log what you've read, and track your reading life without a subscription.",
            },
          ].map(({ q, a }) => (
            <details key={q} className="group border-b border-[#E8E4DC] py-5 first:border-t">
              <summary className="flex items-center justify-between gap-4 cursor-pointer list-none">
                <span className="text-base font-semibold text-[#1A1A1A]">{q}</span>
                <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center text-[#1A1A1A] transition-transform duration-200 group-open:rotate-45 text-xl leading-none">
                  +
                </span>
              </summary>
              <p className="mt-4 pr-10 text-[#6B6B6B] leading-relaxed text-[15px]">{a}</p>
            </details>
          ))}
        </div>
      </section>
